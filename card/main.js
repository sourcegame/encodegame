...
cc.game.onStart = function(){
    ...
    // cc._renderContext.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.NEAREST_MIPMAP_NEAREST);
    ...
    if(cc.sys.isNative) {
        ...
        var GameController = new MGGameController();
    }else {
        if (cc.sys.isMobile)
        {
            //Web mobile
